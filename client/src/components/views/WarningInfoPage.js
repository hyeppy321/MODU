...
import { RiNumber1, RiNumber2, RiNumber3, RiNumber4, RiAlarmWarningLine, RiAlarmWarningFill } from 'react-icons/ri';
    ...
    <Row>
        <Col lg={4} md={6} sm={6} xs={12} className="mb-3">
            <IconWidget
              ...
              OnMouseOver={()=>{setWidgetColor1("hover")}}
              OnMouseOut={()=>{setWidgetColor1("navy")}}
            />
        </Col>
        <Col lg={4} md={6} sm={6} xs={12} className="mb-3">
            <IconWidget
              ...
              OnMouseOver={()=>{setWidgetColor2("hover")}}
              OnMouseOut={()=>{setWidgetColor2("warning")}}
            />
        </Col>
        <Col lg={4} md={6} sm={6} xs={12} className="mb-3">
            <IconWidget
              ...
              OnMouseOver={()=>{setWidgetColor3("hover")}}
              OnMouseOut={()=>{setWidgetColor3("danger")}}
            />
        </Col>
        <Col lg={4} md={6} sm={6} xs={12} className="mb-3">
            <IconWidget
              ...
              OnMouseOver={()=>{setWidgetColor4("hover")}}
              OnMouseOut={()=>{setWidgetColor4("blackgray")}}
            />
        </Col>
        <Col lg={4} md={6} sm={6} xs={12} className="mb-3">
            <IconWidget
              ...
              title="특별여행주의보"
              subtitle={'단기간시행'}
              Onclick={()=>{setIsClick(5)}}
              OnMouseOver={()=>{setWidgetColor5("hover")}}
              OnMouseOut={()=>{setWidgetColor5("special")}}
            />
        </Col>
    </Row>
    <Row>
